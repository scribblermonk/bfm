...
#include "fmindex-collection/string/concepts.h"
...
struct ReducedIndex {
    ...
    /**!\brief Creates a ReducedIndex with a specified sampling rate
     *
     * \param _input a list of sequences
     * \param samplingRate rate of the sampling
     */
    ReducedIndex(Sequences auto const& _input, size_t samplingRate, size_t threadNbr, bool useDelimiters = true, size_t seqOffset = 0) {
        ...
        *this = ReducedIndex{inputText, annotatedSequence, threadNbr, !useDelimiters};
    }
